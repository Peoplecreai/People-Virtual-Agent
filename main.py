...
# === Sheets ===
def get_preferred_name(slack_user_id):
    ...
    for row in records:
        ...
        # Busca si el user_id está contenido en la celda (no solo al final)
        if slack_user_id and slack_user_id in sheet_slack_id:
